    ...
    const generatePads = (card, activePadCount, items) => {
        ...
        rowsConfig.forEach((padCount, rowIndex) => {
            ...
            for (let i = 0; i < padCount; i++) {
                const pad = document.createElement("div"); // Corrected element name
                pad.classList.add("pad"); // Adding class to pad, not padCount
                row.appendChild(pad);
                    ...
                    gsap.to(cardContent, {
                        ...
                        onComplete: () => {
                            gsap.to(pad, {
                                ...
                                duration: 0.3,
                                onComplete: () => {
                                    pad.style.zIndex = "0"; // Corrected the typo here
